class UsersController < ApplicationController
  ...
  def show
    ...
    get_associated_tags
    @statuses = Status.select_by(tags: @tag_list, user: @user, order: params[:order], include_replies: params[:show_replies], page_number: params[:page].present? ? params[:page].to_i : 1)
  end
